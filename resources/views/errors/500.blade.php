...
<div class="max-w-xl w-full">
    <div class="bg-white border-4 border-retro-border shadow-retro-lg rounded-xl overflow-hidden">
        ...
        <!-- HEADER -->
        <div class="bg-red-400 border-b-4 border-retro-border p-8 text-center">
            <h1 class="text-7xl font-black tracking-widest">500</h1>
            <p class="mt-2 text-xl font-bold uppercase">Server Error</p>
        </div>
