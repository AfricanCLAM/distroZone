        ...
        <div class="mx-auto max-w-4xl">
            ...
            <div class="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
                ...
                <p class="hidden md:block text-sm font-medium text-gray-600 max-w-xs text-right">
                    Lengkapi informasi produk kaos yang akan dijual.
                </p>
            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" name="merek" value="{{ old('merek') }}"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('merek') border-red-500 @enderror"
                                    required>
                                @error('merek')
                            ...
                            <div>
                                ...
                                <select name="tipe"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('tipe') border-red-500 @enderror"
                                    required>
                                    <option value="">Pilih Tipe</option>
                                    <option value="Lengan Pendek" {{ old('tipe') == 'Lengan Pendek' ? 'selected' : '' }}>
                                        Lengan Pendek</option>
                                    <option value="Lengan Panjang" {{ old('tipe') == 'Lengan Panjang' ? 'selected' : '' }}>
                            ...
                            <div>
                                ...
                                <input type="text" name="warna_kaos" value="{{ old('warna_kaos') }}"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('warna_kaos') border-red-500 @enderror"
                                    required>
                                @error('warna_kaos')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <select name="ukuran"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('ukuran') border-red-500 @enderror"
                                    required>
                                    <option value="">Pilih Ukuran</option>
                                    @foreach (['XS', 'S', 'M', 'L', 'XL', '2XL', '3XL', '4XL', '5XL'] as $size)
                                        <option value="{{ $size }}" {{ old('ukuran') == $size ? 'selected' : '' }}>
                                            {{ $size }}
                                        </option>
                                    @endforeach
                                </select>
                    ...
                    <div class="mb-10">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="number" name="harga_pokok" value="{{ old('harga_pokok') }}"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('harga_pokok') border-red-500 @enderror"
                                    required>
                                @error('harga_pokok')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="harga_jual" value="{{ old('harga_jual') }}"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('harga_jual') border-red-500 @enderror"
                                    required>
                                @error('harga_jual')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <input type="number" name="stok_kaos" value="{{ old('stok_kaos', 0) }}"
                                    class="retro-input w-full h-12 rounded-lg px-4 @error('stok_kaos') border-red-500 @enderror"
                                    required>
                                @error('stok_kaos')
                                    <p class="text-xs text-red-600 mt-1">{{ $message }}</p>
                                @enderror
                            ...
                            <div>
                                ...
                                <p class="text-xs text-gray-600 mt-1">PNG / JPG • Max 2MB</p>
                            </div>
