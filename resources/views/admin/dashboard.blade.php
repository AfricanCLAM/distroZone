            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2Fxl font-bold text-gray-900">{{ $totalKaos }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">Rp {{ number_format($pemasukanHariIni, 0, ',', '.') }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
                <div class="flex items-center">
                    ...
                    <div class="ml-4">
                        ...
                        <p class="text-2xl font-bold text-gray-900">{{ $transaksiHariIni }}
                        </p>
                    </div>
                </div>
            </div>
        ...
        <div class="bg-white rounded-lg shadow-md p-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <a href="{{ route('admin.karyawan.create') }}"
                    ...
                    <span class="font-medium text-gray-900">Tambah Karyawan</span>
                </a>
                ...
                <a href="{{ route('admin.kaos.create') }}"
                    ...
                    <span class="font-medium text-gray-900">Tambah Kaos</span>
                </a>
